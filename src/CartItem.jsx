...
import { removeItem, updateQuantity, selectTotalItems } from './CartSlice';
import './CartItem.css';
...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Helper function to extract numeric value from item cost
  const parseCost = (cost) => {
    return parseInt(cost.replace(/[^0-9.-]+/g, ""));
  };
        ...
        {cart.map(item => (
          <div className="cart-item" key={item.name}>
            ...
            <div className="cart-item-details">
              ...
              <div className="cart-item-cost">${parseCost(item.cost)}</div>
