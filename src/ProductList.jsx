...
function ProductList() {
  ...
  const totalItems = useSelector(selectTotalItems); // 获取购物车中的商品数量
  ...
  const handleCartClick = (e) => {
    e.preventDefault();
    setShowCart(true); // 显示购物车
  };

  const handleContinueShopping = (e) => {
    e.preventDefault();
    setShowCart(false); // 返回商品列表
  };
      ...
      <div className="navbar">
        ...
        <div className="navbar .ul">
          <a href="#" onClick={handleCartClick} className="cart">
            ...
            <span className="cart_quantity_count">{totalItems}</span> {/* 显示购物车数量 */}
          </a>
        </div>
      </div>
      {!showCart ? (
